...
from PyQt5.QtGui import QIcon, QPainter, QMovie, QPixmap, QColor, QFont, QTextCharFormat, QTextBlockFormat
...
def QueryModifier(Query):
    ...
    question_words = ["how", "what", "who", "when", "why", "which", "whose", "whom", "can you", "what's", "where", "where's", "how's"]
